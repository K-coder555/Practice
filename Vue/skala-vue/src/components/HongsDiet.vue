<template>
  ...
  <div class="m-3">
    ...
    <HongEating @eat="handleEat" />
    <HongTraining @train="handleTrain" />
...
import HongEating from './HongEating.vue';
import HongTraining from './HongTraining.vue';
...
const handleEat = (amount) => { weight.value += amount; };
const handleTrain = (amount) => { weight.value -= amount; };
</script>